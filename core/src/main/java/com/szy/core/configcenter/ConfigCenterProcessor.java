...
public class ConfigCenterProcessor implements
    ...
    public void registerBeanDefinitions(AnnotationMetadata importingClassMetadata, BeanDefinitionRegistry registry) {
        ...
        AnnotationAttributes configScanAttr = AnnotationAttributes.fromMap(
                importingClassMetadata.getAnnotationAttributes(ConfigCenterScan.class.getName()));
        ...
        for (Class beanClazz : beanClazzs) {
            ...
            definition.setBeanClass(ConfigCenterFactory.class);
    ...
    private Set<Class<?>> scannerPackages(String basePackage) throws ClassNotFoundException, IOException {
        ...
        for (Resource resource : resources) {
            ...
            Annotation annotation = clazz.getAnnotation(SConfigCenter.class);
            if (annotation == null) {
                continue;
            }
            set.add(clazz);
